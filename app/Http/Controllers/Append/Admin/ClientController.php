...
class ClientController extends AdminController
{
    ...
    public function index()
    {
        ...
        $items = $this->client_repository->getAllWithPaginate();
    ...
    public function store(StoreClientRequest $request)
    {
        ...
        $client = $this->client_repository->create($data);
        
        // save $request->file('image')
        $this->client_repository->saveImage($client, $request, $this->folder);
        // save $data['active']
        $this->client_repository->setActive($client, $data);
    ...
    public function destroy(Client $client)
    {
        ...
        $this->client_repository->deleteImage($client->image);
        $client->delete();
