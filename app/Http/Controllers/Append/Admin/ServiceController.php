...
class ServiceController extends AdminController
{
    ...
    public function index()
    {
        ...
        $items = $this->service_repository->getAllWithPaginate();
    ...
    public function store(StoreServiceRequest $request)
    {
        ...
        $this->service_repository->saveImage($service, $request, $this->folder);
        // save $data['active']
        $this->service_repository->setActive($service, $data);
    ...
    public function destroy(Service $service)
    {
        ...
        $this->service_repository->deleteImage($service->image);
        $service->delete();
